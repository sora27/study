...
<h5>0권의 도서에 대한 도서정보를 (도서명, 저자명 (각 20자 미만), 가격, 출판년월(예: 2020/12)) 무작위로 1권씩 구조체를 사용하여 입력 받아 최근 출판년월순으로 모든 도서정보를 올림차순 및 내림차순으로 출력하되, 아래 기능을 수행하는 함수를 반드시 포함하는 프로그램을 작성</h5>
